...
- [ ] **Task 2:** Hash chain engine — implement canonical JSON serialization and SHA-256 hash computation (genesis hash, chain linking) with tests — scope: `python`, complexity: `medium`
