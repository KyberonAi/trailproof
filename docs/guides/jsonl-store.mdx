...
<CardGroup cols={2}>
  <Card title="Configuration" icon="file-code" color="#1E40AF" href="/api-reference/config">
    All constructor options for Trailproof.
  </Card>
  <Card title="Verification" icon="shield-check" color="#1E3A8A" href="/guides/verification">
