...
<CardGroup cols={2}>
  ...
  <Card title="HMAC Signing" icon="key" color="#1E3A8A" href="/guides/hmac-signing">
    Add cryptographic provenance to your events.
  </Card>
  <Card title="JSONL Store" icon="file-code" color="#3B82F6" href="/guides/jsonl-store">
    Configure persistent file-based storage.
  </Card>
  <Card title="Verification" icon="shield-check" color="#1E40AF" href="/guides/verification">
